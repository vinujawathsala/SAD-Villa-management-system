 ...
 * @author TUF_Heat_
 */
public class RestunrantOffice extends javax.swing.JFrame {

    private JPanel panel;
    private int frameState;

    /**
     * Creates new form RestunrantOffice
     */
    public RestunrantOffice() {
        initComponents();
    ...
    private void componentStatus(boolean status) {
        if (status) {
            ...
            jButton2.setIcon(new ImageIcon(getClass().getResource("/Resources/arrival.png")));
            jButton3.setText("");
            jButton3.setSize(30, 30);
            jButton3.setIcon(new ImageIcon(getClass().getResource("/Resources/food.png")));
            jButton4.setText("");
            jButton4.setSize(30, 30);
            jButton4.setIcon(new ImageIcon(getClass().getResource("/Resources/event.png")));
            jButton8.setText("");
            jButton8.setSize(30, 30);
            jButton8.setIcon(new ImageIcon(getClass().getResource("/Resources/reservation.png")));
            jButton1.setText("");
            jButton1.setSize(30, 30);
            jButton1.setIcon(new ImageIcon(getClass().getResource("/Resources/bar.png")));
            jButton11.setText("");
            jButton11.setSize(30, 30);
            jButton11.setIcon(new ImageIcon(getClass().getResource("/Resources/product.png")));
            jButton13.setText("");
            jButton13.setSize(30, 30);
            jButton13.setIcon(new ImageIcon(getClass().getResource("/Resources/workers.png")));
            jButton14.setText("");
            jButton14.setSize(30, 30);
            jButton14.setIcon(new ImageIcon(getClass().getResource("/Resources/training.png")));
            jButton9.setText("");
            ...
            jButton2.setText("Today Arrival/Depature List");
            jButton2.setSize(30, 30);
            jButton2.setIcon(new ImageIcon(getClass().getResource("")));
            jButton3.setText("Food Allocation");
            jButton3.setSize(30, 30);
            ...
            jButton8.setText("Resturant Reservation");
            jButton8.setSize(30, 30);
            jButton8.setIcon(new ImageIcon(getClass().getResource("")));
            jButton1.setText("Resturant BAR");
            jButton1.setSize(30, 30);
            ...
            jButton13.setText("Ex/Workers Sheet");
            jButton13.setSize(30, 30);
            jButton13.setIcon(new ImageIcon(getClass().getResource("")));
            jButton14.setText("Ex/Training Programs");
            jButton14.setSize(30, 30);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Resturant Office/ Ex");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        removePanel();
        addPanel(new RestunrantBar(this));

    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        removePanel();
        addPanel(new GuestArrival(this));
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        removePanel();
        addPanel(new ScheduleEvent(this));
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        removePanel();
        addPanel(new RestunrantReservation(this));
