...
public class FrontOffice extends javax.swing.JFrame {
    ...
    private void componentStatus(boolean status) {
        if (status) {
            ...
            jButton3.setIcon(new ImageIcon(getClass().getResource("/Resources/depature.png")));
            jButton4.setText("");
            jButton4.setSize(30, 30);
            jButton4.setIcon(new ImageIcon(getClass().getResource("/Resources/food.png")));
            jButton8.setText("");
            jButton8.setSize(30, 30);
            jButton8.setIcon(new ImageIcon(getClass().getResource("/Resources/room.png")));
            jButton1.setText("");
            jButton1.setSize(30, 30);
            jButton1.setIcon(new ImageIcon(getClass().getResource("/Resources/event.png")));
            jButton11.setText("");
            jButton11.setSize(30, 30);
            jButton11.setIcon(new ImageIcon(getClass().getResource("/Resources/reservation.png")));
            jButton13.setText("");
            jButton13.setSize(30, 30);
            jButton13.setIcon(new ImageIcon(getClass().getResource("/Resources/product.png")));
            jButton14.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        removePanel();
        addPanel(new TodayArrival(this));

    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        removePanel();
        addPanel(new TodayDepature(this));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        removePanel();
        addPanel(new RoomAllocation(this));
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        removePanel();
        addPanel(new ResturantReservation(this));
